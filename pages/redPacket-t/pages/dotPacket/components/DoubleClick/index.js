...
var DoubleClick = (_temp2 = _class = function () {
  function i() {
    var e, t;
    ...
    return (e = t = _possibleConstructorReturn(this, (e = i.__proto__ || Object.getPrototypeOf(i)).call.apply(e, [this].concat(n)))).$usedState = ["anonymousState__temp", "style", "doubleHitCount", "isDoubleHitShow"], t.customComponents = [], _possibleConstructorReturn(t, e);
  }
...
}(), _class.$$events = [], _class.$$componentPath = "pages/redPacket-t/pages/dotPacket/components/DoubleClick/index", _temp2);
exports.default = DoubleClick, Component(require("../../../../npm/@tarojs/taro-weapp/index.js").default.createComponent(DoubleClick));