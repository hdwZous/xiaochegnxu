...
var RuleDia = (_temp2 = _class = function () {
  function s() {
    ...
    return (e = t = _possibleConstructorReturn(this, (e = s.__proto__ || Object.getPrototypeOf(s)).call.apply(e, [this].concat(n)))).$usedState = ["style", "txt", "title"], t.onClose = function () {
      t.props.onCloseDia;
      t.props.onCloseDia();
  ...
  return _inherits(s, _index.Component), _createClass(s, [{
    ...
    key: "onTouchMove",
    value: function (e) {
      return console.log("e", e), e.preventDefault(), e.stopPropagation(), !1;
    }
  }, {
    key: "_createData",
    value: function () {
...
}(), _class.$$events = ["anonymousFunc0", "onTouchMove", "anonymousFunc1"], _class.$$componentPath = "pages/firstOrderFission-t/components/popDia/index", _temp2);
