...
var Default = (_temp2 = _class = function () {
  function a() {
    ...
    return (e = t = _possibleConstructorReturn(this, (e = a.__proto__ || Object.getPrototypeOf(a)).call.apply(e, [this].concat(o)))).$usedState = ["_$anonymousState__temp", "defaultType", "style", "tipsMsg", "defaultTips", "defaultBtnTxt", "defaultImg", "backgroundColor", "locationError", "localTargetUrl", "channel"], t.customComponents = [], _possibleConstructorReturn(t, e);
  }
  ...
  return _inherits(a, _index.Component), _createClass(a, [{
    ...
    value: function () {
      ...
      return 0 === i || (1 === i ? (this.anonymousFunc0 = function (e) {
        return t.goToAddress(e);
      }, this.anonymousFunc1 = function (e) {
        return t.goToSetting(e);
      }) : 2 === i ? e = r ? (0, _index.internal_inline_style)({
        backgroundColor: n
      }) : null : 3 === i ? this.anonymousFunc2 = function () {
        return t.onDefaultEvent();
      } : 4 === i && (this.anonymousFunc3 = function () {
        return t.goLogin();
  ...
  addGlobalClass: !0
}, _class.$$componentPath = "pages/takeCoupon-t/components/default/index", _temp2);
