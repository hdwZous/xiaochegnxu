...
var RuleDia = (_temp2 = _class = function () {
  function s() {
    ...
    return (e = t = _possibleConstructorReturn(this, (e = s.__proto__ || Object.getPrototypeOf(s)).call.apply(e, [this].concat(o)))).$usedState = ["style", "title", "txt"], t.onClose = function () {
      t.props.onCloseDia;
      t.props.onCloseDia();
...
}(), _class.$$events = ["anonymousFunc0", "anonymousFunc1"], _class.$$componentPath = "pages/takeCoupon-t/components/ruleDia/index", _temp2);
