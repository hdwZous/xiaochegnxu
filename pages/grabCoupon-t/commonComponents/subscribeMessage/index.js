...
var _class,
  ...
  if (null !== t) return e(t, s, a);
    ...
    _indexWeapp2 = require("../../npm/@jd/djmp/common-t/constants/index.weapp.js"),
...
var SubscribeMessage = (_temp2 = _class = function () {
  ...
  return _inherits(n, _index.Component), _createClass(n, [{
    ...
    key: "getLoginInfo",
    value: function () {
      var e = (0, _indexWeapp3.getStorageSync)(_indexWeapp2.LOGIN_INFO);
    ...
    value: function (e, t, s, a) {
      ...
      console.log("==========templates==========", o), (0, _index3.subscribeMsginfo)({
        openId: n.openId || "",
        templates: o
      }).then(function (e) {
        console.log("==========res==========", e);
    ...
    value: function (e, t, s) {
      ...
      switch (e) {
        ...
        case "sUt2OT-SDxpcLcAp2MB_kJqF69ohZ5-Wjt8OnBDSscso":
          a = 11;
          break;
...
}(), _class.$$events = ["hiddenSubscribeMessage"], _class.$$componentPath = "pages/grabCoupon-t/commonComponents/subscribeMessage/index", _temp2);
