  ...
  */
  ...
  methods: {
    ...
    loadCard(isRequest) {
      ...
      console.log(isRequest, feedsList)
      const query = wx.createSelectorQuery()
      query.select('#globalshopCart').boundingClientRect(react => {
        console.log(react.height)
        this.triggerEvent('onPageHeight', { height: react.height, flag: true, skuisRequest: isRequest, skuList: isRequest && left.length + right.length })
      }).exec();
