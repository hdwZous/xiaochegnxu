    ...
    handleSuccess(result) {
      result.data &&
        result.data.forEach((floor) => {
          ...
          if (floor.floorStyle == "coupon" && floor.tpl == "tplC-1") {
            if (floor.data.length > 9) {
              floor.data = floor.data.slice(0, 9);
            }
          }
        });
      ...
      this.setData(
        {
          floorList: this.floorList.splice(0, 4),
          showEmpty: false,
