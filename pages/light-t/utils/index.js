...
var isWeapp = !0,
    shareFlag = !0,
    imgLoad = function (n, r) {
  var a = 0;
  n.forEach(function (e) {
    var t = setInterval(function () {
      e.complete && (a += 1, clearInterval(t), a === n.length && r());
    }, 50);
  });
};
...
var urlList = [],
  ...
  urlList.includes(e) || (urlList.push(e), _index2.default.getImageInfo({
    src: e
  }));
};
...
function debounceImmediate(r, a, o) {
  var i;
  return function () {
    var e = this,
        t = arguments,
