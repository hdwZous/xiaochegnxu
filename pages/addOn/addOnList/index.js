...
Page({
  ...
  handleSearchClick(e) {
    ...
    wx.navigateTo({
      // url: '/pages/addOn/addOnListSearch/index?stationNo=' + instant.data.storeId +'&keyword=' + instant.data.keyword + '&couponId=' + instant.data.couponId + '&longitude=' + instant.data.longitude + '&latitude=' + instant.data.latitude + "&orgCode=" + instant.data.orgCode ,
      url: `/pages/addOn/addOnListSearch/index?storeId=${storeId}&orgCode=${orgCode}&couponId=${couponId}&keyword=${keyword}&priceDiff=${priceDiff}&pageSource=${pageSource}&limitType=${limitType}&from=${this.data.from}`,
      preObj: recommendObj,
      buried_position: {
        currentPageName: 'addon_addonlist_handleSearchClick'
      }
    });
    this.setData({
