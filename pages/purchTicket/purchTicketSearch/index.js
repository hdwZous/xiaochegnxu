...
Page({
  ...
  onMiniCartWidgetEvent(e) {
    ...
    if (type === "min") {
      //减车埋点
      this.reportClickReduce(data.skuId, this.data.storeId, "mini_shopcar");
    } else if (type === "add") {
      //加车埋点
      this.reportClickAdd(data.skuId, this.data.storeId, "mini_shopcar");
    }
    if (type === "miniCartClear") {
      // 清除购物车
    } else if (type === "miniCartToLogin") {
      // 去登录
    } else if (type === "miniCartToBill") {
      // 去结算
      wx.navigateTo({
        url:
        ...
        preObj: this.data.recommendObj,
        buried_position: {
          key: "purchTicketSearch-onMiniCartWidgetEvent",
  ...
  onAddMinControllerChange(e) {
    ...
    if (type === "min") {
      //减车埋点
      this.reportClickReduce(data.skuId, this.data.storeId, "");
    } else if (type === "add") {
      //加车埋点
      this.reportClickAdd(data.skuId, this.data.storeId, "");
      this.setData({
  ...
  toStoreClick() {
    ...
    if (index != null) {
      ...
      wx.navigateTo({
        ...
        preObj: this.data.recommendObj,
        buried_position: {
          key: "purchTicketSearch-toStoreClick",
          options: this.data.options,
        },
      });
    }
  ...
  toStoreClickBottom() {
    ...
    if (index != null) {
      ...
      wx.navigateTo({
        ...
        preObj: this.data.recommendObj,
        buried_position: {
          key: "purchTicketSearch-toStoreClickBottom",
          options: this.data.options,
        },
      });
    }
  ...
  goToDetail(e) {
    ...
    wx.navigateTo({
      ...
      preObj: this.data.recommendObj,
      buried_position: {
        key: "purchTicketSearch-goToDetail",
        options: this.data.options,
      },
    });
    let {
